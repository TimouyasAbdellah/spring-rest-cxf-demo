...
public class GsonHttpMessageConverter extends AbstractHttpMessageConverter<Object> {
	...
	public GsonHttpMessageConverter(boolean serializeNulls) {
		this(serializeNulls ? new GsonBuilder().serializeNulls().setDateFormat("yyyy-MM-dd'T'HH:mm:ss.SSSZ").create() : new Gson());
	}
	...
	protected Object readInternal(Class<?> clazz, HttpInputMessage inputMessage) throws IOException, HttpMessageNotReadableException {
		...
		Reader json = new InputStreamReader(body, getCharset(inputMessage.getHeaders()));
